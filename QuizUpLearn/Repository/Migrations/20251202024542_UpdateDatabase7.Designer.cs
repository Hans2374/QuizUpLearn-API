...
namespace Repository.Migrations
{
    ...
    [Migration("20251202024542_UpdateDatabase7")]
            ...
            modelBuilder.Entity("Repository.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<int>("AiGenerateQuizSetMaxTimes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Repository.Entities.UserWeakPoint", b =>
                {
                    ...
                    b.HasOne("Repository.Entities.UserMistake", "UserMistake")
                        .WithOne("UserWeakPoint")
                        .HasForeignKey("Repository.Entities.UserWeakPoint", "UserMistakeId");

                    b.Navigation("User");

                    b.Navigation("UserMistake");
                });
