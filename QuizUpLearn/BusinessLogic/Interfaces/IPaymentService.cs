...
namespace BusinessLogic.Interfaces
{
    ...
    {
        public Task<CreatePaymentResult?> CreatePaymentLinkAsync(int amount, string description, List<ItemData> items);
        ...
        public Task<string> ConfirmWebhookUrl(string webhookUrl);
    }
}
